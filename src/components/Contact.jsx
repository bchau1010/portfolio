...
//form tag "action" mean submit data to the address specified
//method="Post" will send the form data as http post transaction
//input tag, field where user can enter data (for form)
//type, can be different type such as button, checkbox, etc
//place holder: Display what type of input
//text area tag, create a text box
//button, self explain
function Contact() {
   return (
      <>
         <div id="contact" className="flex flex-col mb-10 mx-auto">
            <div className="flex justify-center items-center">
               {/*NEED A CUSTOM SLUG HERE FROM THE WEBSITE */}
               <form
                  action="https://getform.io/f/zazkzodb"
                  method="POST"
               ...
               >
                  ...
                  <div className="flex flex-wrap gap-5">
                     ...
                     <div className="self-start flex flex-wrap justify-center gap-2">
                        <a href="https://www.linkedin.com/in/bao-chau-684205252/"
                           target="_blank"
                        ...
                        <a
                           href="https://github.com/bchau1010"
                           target="_blank"
                           className="bg-stone-400 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded-full">
                        ...
                        <a
                           href="/assets/MAIN RESUME V5.pdf"
                           target="_blank"
                           className="bg-stone-400 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded-full">
