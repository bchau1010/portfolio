...
function Intro() {
   return (
      <div id="intro" className="flex items-center justify-center flex-col text-center pt-20 pb-6">
         <h1 className="self-start text-5xl md:text-7xl dark:text-white mb-1 md:mb-3 font-bold">Bao Chau</h1>
         <p className="self-start text-base md:text-xl mb-3 font-medium">Software Engineer & Backend Developer</p>
